    ...
    return Scaffold(
      bottomNavigationBar: BottomNavigationBar(
        ...
        BottomNavigationBarItem(
          icon: IconButton(onPressed: (){}, icon: Icon(Icons.home, color: Colors.black, size: 35.0,)),
          label: ''),
        BottomNavigationBarItem(
          icon: IconButton(icon: Icon(Icons.search, color: Colors.black, size: 35.0,),
          ...
          label: '',),
        BottomNavigationBarItem(icon: Icon(Icons.add_box_outlined, color: Colors.black, size: 35.0,), label: ''),
        BottomNavigationBarItem(icon: IconButton(onPressed: (){}, icon: Icon(Icons.favorite_outline_outlined, color: Colors.black,)), label: ''),
        BottomNavigationBarItem(icon: GestureDetector(child: CircleAvatar(backgroundImage: AssetImage('assets/images/Mypfp.jpg')), onTap: (){Navigator.push(
          context,
          MaterialPageRoute(
        ...
        actions: [
          Padding(
            ...
            child: Transform.scale(
              scale: 1.35,
              child: IconButton(onPressed: (){}, icon: const Icon(Icons.add_box_outlined), color: Colors.black, )
            ),
          ),
          IconButton(
            onPressed: (){},
            icon: Image.asset('assets/images/messenger.jpg', width: 27.0, height: 27.0,),
          )
        ],
      ),
      body: ListView(
        children: [
          SizedBox(
                ...
                return Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      const Text('Your Story', style: TextStyle(fontSize: 15.0),)
                    ],
                  ),
                );
              },
            ...
            //             onTap: (){},
            //           ),
            //           const Text('story1', style: TextStyle(fontSize: 15.0),)
            //         ],
            //       ),
            //     ),
            //     Padding(
            ...
            //             onTap: (){},
            //           ),
            //           const Text('story2', style: TextStyle(fontSize: 15.0),)
            //         ],
            //       ),
            //     ),
            //     Padding(
            ...
            //             onTap: (){},
            //           ),
            //           const Text('story3', style: TextStyle(fontSize: 15.0),)
            //         ],
            //       ),
            //     ),
            //     Padding(
            ...
            //             onTap: (){},
            //           ),
            //           const Text('story4', style: TextStyle(fontSize: 15.0),)
            //         ],
            //       ),
            //     ),
            //   ],
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Text('Beans, Cheese and Rice...')
                      ],
                    )
                    ],
                );
